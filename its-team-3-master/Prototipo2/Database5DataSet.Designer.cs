...
namespace Prototipo2 {
    ...
    public partial class Database5DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string email, string password, string nome, string cognome) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow FindBypassword(string password) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string cognome {
                get {
                    try {
                        return ((string)(this[this.tableTable.cognomeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'cognome\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.cognomeColumn] = value;
                }
            }
            ...
            public bool IscognomeNull() {
                return this.IsNull(this.tableTable.cognomeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetcognomeNull() {
                this[this.tableTable.cognomeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Prototipo2.Database5DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([email] = @Original_email) AND ([password] = @Original_password) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_cognome = 1 AND [cognome] IS NULL) OR ([cognome] = @Original_cognome)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([email], [password], [nome], [cognome]) VALUES (@email" +
                ", @password, @nome, @cognome);\r\nSELECT email, password, nome, cognome FROM [Tabl" +
                "e] WHERE (password = @password)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [email] = @email, [password] = @password, [nome] = @nome, [cognome] = @cognome WHERE (([email] = @Original_email) AND ([password] = @Original_password) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_cognome = 1 AND [cognome] IS NULL) OR ([cognome] = @Original_cognome)));
SELECT email, password, nome, cognome FROM [Table] WHERE (password = @password)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Prototipo2.Properties.Settings.Default.Database5ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT email, password, nome, cognome FROM dbo.[Table]";
        ...
        public virtual int Fill(Database5DataSet.TableDataTable dataTable) {
        ...
        public virtual Database5DataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database5DataSet.TableDataTable dataTable = new Database5DataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database5DataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(string Original_email, string Original_password, string Original_nome, string Original_cognome) {
            ...
            if ((Original_cognome == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_cognome));
            }
        ...
        public virtual int Update(string email, string password, string nome, string cognome, string Original_email, string Original_password, string Original_nome, string Original_cognome) {
            if ((email == null)) {
                throw new global::System.ArgumentNullException("email");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string email, string nome, string cognome, string Original_email, string Original_password, string Original_nome, string Original_cognome) {
            return this.Update(email, Original_password, nome, cognome, Original_email, Original_password, Original_nome, Original_cognome);
        }
    }
